...
import styles from "../../styles/pages/search/about.module.css"
    ...
    return (
      <div className="search-about-wrapper">
        ...
        <div className="search-about-content">
          ...
          <p>Coder News search provides real-time full-text search for the Coder News community website. The search backend is implemented using <a href="http://www.algolia.com">Algolia</a> instant search engine.</p>
          <h3>How it works</h3>
