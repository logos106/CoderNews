...
import "../styles/pages/newsguidelines.module.css"
    ...
    return (
      <div className="news-guidelines-wrapper">
        ...
        <div className="news-guidelines-text-container">
          <p className="news-guidelines-text-title">Coder News Guidelines</p>
          <p className="news-guidelines-text-title">What to Submit</p>
          <p>On-Topic: Anything that coders would find interesting. That includes more than just coding and startups. If you had to reduce it to a sentence, the answer might be: anything that gratifies one’s intellectual curiosity.</p>
          <p>Off-Topic: Most submissions about politics, or crime, or sports, unless they're evidence of some interesting new phenomenon. Videos of pratfalls or disasters, or cute animal pictures. If they'd cover it on TV news, it’s probably off-topic.</p>
          ...
          <p>Be kind. Don’t be snarky. Comments should get more thoughtful and substantive, not less, as a topic gets more divisive.</p>
          ...
          <p>Please don’t use Coder News for political or ideological battle. That destroys intellectual curiosity, which is what the site exists for.</p>
          ...
          <p>Throwaway accounts are ok for sensitive information, but please don’t create accounts routinely. Coder News is a community—users should have an identity that others can relate to.</p>
          ...
          <p>Please don’t submit comments saying that Coder News is turning into Reddit. It’s a semi-noob illusion, as old as the hills.</p>
