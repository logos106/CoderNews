...
import "../styles/pages/newsfaq.module.css"
    ...
    return (
      <div className="news-faq-wrapper">
        ...
        <div className="news-faq-text-container">
          <p className="news-faq-text-title">Coder News FAQ</p>
          ...
          <p>If you have an email address in your profile, request a password reset <a href="/forgot">here</a>. If you haven’t, email support@codernews.com for help.</p>
